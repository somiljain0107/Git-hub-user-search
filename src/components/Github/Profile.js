            ...
            <div className="panel-body">
                <div className="row">
                    <div className="col-md-4">
                        ...
                        <a href={this.props.userData.html_url} target="_blank" className="btn btn-default btn-block">User Profile</a>
                    </div>
                    <div className="col-md-8">
                        <div className="row">
                            <div className="col-md-12">
                                <span className="label label-default">{this.props.userData.public_repos} Public Repositories</span>
